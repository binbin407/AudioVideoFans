...
**FR-10**：电视剧与动漫支持季（Season）与集（Episode）两级层级结构，季有独立详情页；在剧集/动漫详情页中，季列表以手风琴形式展示，每个季条目折叠状态下显示季海报缩略图（无海报时显示灰色占位符）、季名称、集数、首播日期、季均分（有数据时显示）及季简介（超 3 行截断并显示省略号）；点击展开后海报与简介保持可见，下方列出该季全部集信息
